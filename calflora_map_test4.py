...
# -----------------------------
project_id = "pr940"
MGP_shapeID = "rs1515"  # optional if needed later
...
max_per_page = 100  # API maximum per page
total_limit = 1000  # stop after 1000 records
...
# -----------------------------
# FETCH OBSERVATIONS FOR PROJECT (UP TO 1000)
# -----------------------------
all_data = []
start_index = 0
...
while True:
    ...
    api_url = f"https://api.calflora.org/observations?projectIds={project_id}&maxResults={fetch_count}&startIndex={start_index}"
...
print(f"Total records fetched (capped at {total_limit}): {len(all_data)}")
